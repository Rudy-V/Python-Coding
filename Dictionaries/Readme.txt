...
● Next, create a dictionary called stock, which should contain the stock value
...
You will need to remember to loop through the appropriate dictionaries
and lists to do this.
